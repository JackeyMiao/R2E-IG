...
env_params = {
    ...
    'load_path': '../../../data/vrp/vrp_uniform20_10000.pkl',
    'load_raw': None
}
...
tester_params = {
    ...
    'model_load': {
        "path": 'result/20MOE/checkpoint-best.pt', # directory path of pre-trained model and log files saved.
