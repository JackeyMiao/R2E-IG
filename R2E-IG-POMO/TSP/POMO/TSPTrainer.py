...
from TSPTester import validate
...
class TSPTrainer:
    ...
    def _train_one_moe_epoch(self, epoch):
        ...
        # mix_three_score_AM, mix_three_task_loss_AM, mix_three_aux_loss_AM, mix_three_loss_AM = AverageMeter(), AverageMeter(), AverageMeter(), AverageMeter()
    ...
    def _train_one_moe_minibatch(self, minibatch_size, distribution, cumulate_weight):
        ...
        if not self.model_params['is_moe']:
